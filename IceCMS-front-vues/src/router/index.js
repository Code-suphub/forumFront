...
export const constantRoutes = [
  ...
  {
    path: '/loginAdmin',
    component: () => import('@/views/login/indexAdmin'),
    hidden: true
  },
  {
    path: '/404',
  ...
  {
    path: '/post/:id(\\d+)',
    component: () => import('@/page/article/Post.vue'),
    hidden: true
  },
  {
    path: '/post/all',
    component: () => import('@/page/article/AllPost.vue'),
    hidden: true
  },
  {
    path: '/class',
  ...
  },
  {
    ...
    component: () => import('@/page/user/OtherUserInfo.vue'),
    hidden: true
  },
  {
    path: '/userinfo',
  ...
  {
    path: '/about',
    component: () => import('@/page/other/About.vue'),
    hidden: true
  },
  {
    path: '/privacy',
    component: () => import('@/page/other/Privacy.vue'),
    hidden: true
  },
  {
    path: '/protocol',
    component: () => import('@/page/other/Protocol.vue'),
    hidden: true
  },
  {
    path: '/disclaimer',
    component: () => import('@/page/other/Disclaimer.vue'),
    hidden: true
  },
  {
    path: '/contact',
    component: () => import('@/page/other/Contact.vue'),
    hidden: true
  },
  // admin page home
  {
