<template>
  <header class="app-header" data-v-7cf0e7dc="">
      ...
      <div class="box">
        ...
        <el-form ref="RegisterForm" :model="RegisterForm" :rules="registerRules"
          ...
          <el-form-item prop="username">
            <el-input ref="username" v-model="RegisterForm.username"
        ...
        <div>个人信息</div>
          ...
          <el-button :loading="loading" type="primary"
                     style="width: 100%; margin-bottom: 30px" @click.native.prevent="userRegister">立即注册
          </el-button>
          <div data-v-11bb2e85="" class="ss-login_statement">
            <span data-v-11bb2e85="">登陆注册即代表同意</span>
            <router-link to="/Protocol">
              <a data-v-11bb2e85="" target="_blank">用户协议</a>
            </router-link><span data-v-11bb2e85="">及</span>
            <router-link to="/Privacy">
              <a data-v-11bb2e85="" target="_blank">隐私条款</a>
            </router-link>
          </div>
          <div data-v-11bb2e85="" class="line"></div>
          <div data-v-11bb2e85="" class="footer">
            <p data-v-11bb2e85="" class="text-align-center">其他登录方式
              <a style="text-decoration: none">或</a>{{ "\xa0" }}
    ...
    <el-dialog class="dialogdeep" width="30%"
               top="30px" center title=""
      ...
      <div class="box">
        ...
        <label class="login-form-item" style="display: none">
          <input type="text" name="nickname"
                 tabindex="1" spellcheck="false" autocomplete="off" class=""/>
          <span><b>可爱的昵称</b></span>
        </label>
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules"
          ...
          <el-button :loading="loading" type="primary"
                     style="width: 100%; margin-bottom: 30px" @click.native.prevent="handleLogin">登陆
          </el-button>
          <div data-v-11bb2e85="" class="ss-login_statement">
            <span data-v-11bb2e85="">登陆注册即代表同意</span>
            <router-link to="/Protocol">
          ...
          <div data-v-11bb2e85="" class="footer">
            <p data-v-11bb2e85="" class="text-align-center">
              其他登录方式<a style="text-decoration: none">或</a>{{ "\xa0" }}
      ...
      <div class="app-header-main" data-v-122eae44="">
        <router-link target="_self" data-v-122eae44="" aria-current="page" to="/">
          <a class="app-header-logo active" data-v-122eae44="" aria-current="page">
            ...
            <span data-v-122eae44="">{{this.glabledata.glableSitTitle }}</span>
          </a>
        </router-link>
        <div class="app-header-nav nav" data-v-122eae44="">
          <router-link target="_self" class="nav-link" :class="message1"
                       data-v-122eae44="" aria-current="page" to="/">首页</router-link>
          <router-link target="_self" class="nav-link" :class="message3"
                       data-v-122eae44="" to="/post/all">文章</router-link>
          <router-link target="_self" class="nav-link display-top"
                       :class="message5" data-v-1f33282a="" to="/planet">圈子</router-link>
          <router-link target="_self" class="nav-link" :class="message2"
                       data-v-1f33282a="" to="/list">商品</router-link>
          <router-link target="_self" class="nav-link " :class="message4"
                       data-v-1f33282a="" to="/class">分类</router-link>
        </div>
        <div class="app-header-search grid-list lazy-transition" data-v-122eae44="">
          <div id="autosuggest" data-v-122eae44="">
            <div role="combobox" aria-expanded="false" aria-haspopup="listbox" aria-owns="autosuggest-autosuggest__results">
              <el-input @keyup.native="keyup()" @focus="focus()"
                        @blur="blur()" v-model="searchContent"
                        type="text" autocomplete="off" aria-autocomplete="list"
                        aria-activedescendant="" aria-controls="autosuggest-autosuggest__results"
                        id="autosuggest__input" placeholder="输入关键词搜索软件或文章…"
                        value="" class=""/>
            </div>
            <div class="popUp" v-show="searchshow"
              ...
              <div aria-labelledby="autosuggest" class="autosuggest__results">
                <div data-v-6d6103b4="" class="overflow-hidden">
                  <div data-v-6d6103b4="" class="d-flex align-items-center px-5">
                    <a @click="codeshows()" data-v-6d6103b4=""
                      ...
                      <span data-v-6d6103b4="" class="fs-12">({{ ResourceNumber }})</span>
                    </a>
                    <a @click="articleshows()" data-v-6d6103b4=""
                       :class="{ 'active search-active': articleshow }"
                       class="flex flex-grow-1 text-center py-3 fs-16">
                      <span data-v-6d6103b4="" class="">文章</span>
                      <span data-v-6d6103b4="" class="fs-12">({{ articleCount }})</span>
                    </a>
                  </div>
                </div>
                <ul role="listbox">
                        ...
                        <li role="option" data-suggestion-index="0" data-section-name="default"
                          ...
                          <a data-v-6d6103b4="" class="macwk-app white border-top">
                            ...
                            <div data-v-6d6103b4="" class="macwk-app__body py-1">
                              <h5 data-v-6d6103b4="" class="macwk-app__body--title fs-14" style="display: -webkit-box; -webkit-box-orient: vertical; overflow: hidden; word-break: break-all; text-overflow: ellipsis; -webkit-line-clamp: 1;">
                          ...
                          > -->
                              ...
                              <p data-v-6d6103b4="" class="macwk-app__body--info" style="display: -webkit-box; -webkit-box-orient: vertical; overflow: hidden; word-break: break-all; text-overflow: ellipsis; -webkit-line-clamp: 1;">
                ...
                <div data-v-6d6103b4="">
                  <button data-v-6d6103b4=""
                    class="btn btn-block border-top no-radius py-3 hover-primary cursor-pointer fs-14">
                    查看更多
              ...
              <div class="topic-names">
                <div>
                  <div class="topic-name-datas">
                    <a target="_blank"><b>{{ this.user.name }}</b></a>
                  </div>
                  <div class="topic-user-lvs">
                    <p>
                      <span class="user-vips"><i style="border-color: #ff8223"></i>
                        <b v-show="vipTrue" style="color: #ff8223">会员</b>
                      </span>
                    </p>
                    <p>
          ...
          <div slot="reference">
            <router-link to="/userinfo/index">
              <div v-if="!userJudje" class="avatartext">
                <el-avatar :src="this.user.avatar"></el-avatar>
                <span class="spans">{{ this.user.name }}</span>
              </div>
            </router-link>
          </div>
        </el-popover>
...
import {  getAllResourceNumber } from '@/api/webresource'
import {  getAllArticleNumber } from '@/api/article'

import { checkVip } from '@/api/user'
import { testEmail } from '@/api/user'


import { mapState } from 'vuex'
import {getUser, removeUser, setUser} from "@/utils/userUtils";
import {getListRespData, getResultRespCode, getResultRespData} from "@/utils/respUtils";
  ...
  methods: {//用户注册
    ...
    fullnum: function () {
      getAllResourceNumber().then(resp => {
        this.ResourceNumber = getResultRespData(resp)
      })
      getAllArticleNumber().then(resp => {
        this.articleCount = getResultRespData(resp)
      })
    },
    async loginout() {
      //退出登陆
    ...
    getUserInfo() {
      ...
      if(user != null){
        ...
        //获取会员有效性
        checkVip(this.user.userId).then(resp => {
      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          login(that.loginForm).then(resp => {
            if (getResultRespCode(resp) === 400) {
                that.$message({
                  message: '用户名不存在, 请确认后再登陆',
                  type: 'warning'
                })
            } else{
              localStorage.setItem('access-admin', JSON.stringify(resp.data.data))
              this.$store.commit('setLogin',{sign:true,data:resp.data.data})
              // 关闭登录框
              that.dialogFormVisible = false
              // 关闭登陆按钮
    ...
    Findresource(searchContent, num) {
      FindresourceByNum(searchContent, num).then(resp => {
        this.tempdata = getResultRespData(resp)
      })
    },
    findArticles(searchContent, num) {
      const allQuery={
        content: searchContent,
          page: 1,
          limit: num
      }
      findAllArticle(searchContent,1 , num).then(resp => {
        this.tempdata = getListRespData(resp)
      })
    },
    //临时查询
    search(searchContent) {
      ...
      //限制查询五个数据
      if (!this.judgeNull(this.searchContent)) {
        if (this.fundByresource) {
          this.Findresource(searchContent, 5) }
        else {
          this.findArticles(searchContent, 5) }
    ...
    queryssubmit() {
      ...
      if (this.judgeNull(this.searchContent)) {
        ...
        if(this.fundByresource){
          this.$router.push({
          path: `/list/${this.searchContent}/all`,
        })
        }else{this.$router.push({
          path: `/post/${this.searchContent}/all`,
        })}
      }
    },
    articleshows() {
      ...
      this.findArticles(this.searchContent, 5)
      this.howto = '/post/'
    ...
    codeshows() {
      ...
      this.Findresource(this.searchContent, 5)
      this.howto = '/list/'
    },
    focus() {
      this.searchshow = true
