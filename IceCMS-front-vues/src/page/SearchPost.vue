                  ...
                  <div class="d-flex">
                    <div class="flex">
                      ...
                      <div v-for="(item, id) in this.list" :key="id">
                        ...
                        <router-link :target="istarget" :to="'/post/' + item.id">
                          ...
                          <a target="_self" class=" post-item white delay-0 list-animation-leftIn">
                            <img v-if="item.thumb != null" class="post-item__preview delay-0" lazy="loading" :src="item.thumb"/>
                      ...
                      <pagination class="app-content-bottom" v-show="total > 0"
                                  :background="false" :total="total" :page.sync="listQuery.page"
              ...
              <div id="sidetools" class="macwk-animation tinUpIn" style="display: none">
                ...
                <span>
                  <div role="tooltip" id="el-popover-3962"
                       aria-hidden="true" class="el-popover el-popper" style="width: 200px; display: none">
                    <!---->
                ...
                <span>
                  <div role="tooltip" id="el-popover-1793" aria-hidden="true" class="el-popover el-popper" style="width: 200px; display: none">
                    <!---->
                    <div class="text-center">
                      <a href="feedback.html" class="mt-15 mb-0">在线留言</a>
                    </div>
...
<script>
import {getAllArticle, getAllArticleNumber} from '@/api/article'
  ...
  methods: {
    ...
    getList() {
        ...
        getAllArticle(this.listQuery).then(resp => {
          const data = getListRespData(resp)
          this.list = data
          this.total = getListRespTotal(resp)
          this.articleCount = getListRespTotal(resp)
          this.listLoading = false
      })
      getAllArticleNumber().then(resp => {
        this.articleNum = getResultRespData(resp)
      })
    },
  }
}
