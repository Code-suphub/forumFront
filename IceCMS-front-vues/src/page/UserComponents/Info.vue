              ...
              <el-row>
                <el-col :span="8">
                  <el-form-item label="昵称：">
                    <el-input style="width: 220px" v-model="user.nickName"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="8">
        ...
        <el-form-item label="出生日期">
          <el-col :span="11">
            <el-date-picker type="date" placeholder="选择日期"
                            v-model="this.user.birthday" style="width: 100%"
            ></el-date-picker>
          </el-col>
        </el-form-item>
...
import {getUser, removeUser, setUser, setUserWithUser} from "@/utils/userUtils";
import {getResultRespCode} from "@/utils/respUtils";
...
export default {
  ...
  methods: {
    onSubmit() {
      const user = getUser()
      changeUser(user.token, this.user).then(resp => {
