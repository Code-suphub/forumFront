<template>
    <div class="home">
      <div class="homeContent">
        <div class="mw-row" style="width: 100%;display: flex;flex-wrap: wrap;">
        <div style="margin-left: 30px;width: 220px;" v-for="item in dataFrom">
            ...
            <a  class="macwk-app border white cursor-pointer padding-xl">
              <div data-v-2661c954="" class="soft-card">
                ...
                <div data-v-2661c954="" class="size-12 text-B6BABF margin-top-90"
                  ...
                  <span data-v-2661c954="">{{item.author }}</span>
                </div>
                <div data-v-2661c954=""
                ...
                <div data-v-2661c954="" class="margin-top2 text-B6BABF flex-row size-12"
                  ...
                  <div data-v-2661c954="">
                    ...
                    <span data-v-2661c954="">{{ item.hits }}</span>
                  </div>
                  <div data-v-2661c954="" style="margin-left: 6px;" class="margin-left">
                    <i data-v-2661c954="" class="el-icon-star-on"></i>
                    <span data-v-2661c954="">{{ item.loveNum }}</span>
                  </div>
                </div>
              </div>
            </a>
  ...
  <script>
import { getAllArticleByAuthor } from '@/api/article'
...
import {getListRespData} from "@/utils/respUtils";
  ...
  export default {
    ...
    methods: {
      getMyArticle() {
        getAllArticleByAuthor(this.user.userId).then(resp => {
        this.dataFrom = getListRespData(resp)
      })
    },
    }
  }
