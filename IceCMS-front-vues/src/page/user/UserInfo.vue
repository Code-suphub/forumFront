    ...
    <div data-server-rendered="true" id="__nuxt">
      ...
      <div id="__layout">
        <div data-fetch-key="0" class="app light macwk-animation">
                ...
                <div id="author" class="author wrapper">
                  <div class="box b2-radius author-header">
                    ...
                    <div class="user-panel">
                      <div class="avatar">
                        <el-avatar shape="square" :size="150" :src="user.avatar">{{user.avatar}}</el-avatar>
                      ...
                      <div class="user-panel-info">
                        <div class="">
                          <h1>
                            <span id="userDisplayName" class="userTopName">{{user.nickName }}</span><span class="user-page-lv">
                            <span class="lv-icon user-lv b2-lv0"><b>Lv0新手上路</b><i>lv0</i></span></span>
                          </h1>
                          <p>{{user.intro}}</p>
                        </div>
                      </div>
                      ...
                      <div class="author-page-right-in box b2-radius">
                        <div>
                          ...
                          <router-link to="/userinfo/index">
                            <div @click="sidebarActivate('profile')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active':this.sidebarItems['profile']}">
                                <a class="link-block"></a>
                                <p>
                                  <i class="b2font b2-user-heart-line b2-light b2-color"></i>概览
                                </p>
                          ...
                          <router-link to="/userinfo/post">
                            <div @click="sidebarActivate('works')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['works']}">
                                <a class="link-block"></a>
                                <p>
                                  <i class="b2font b2-quill-pen-line b2-light b2-color"></i>作品查看
                                </p>
                                <div class="author-sidebar-down">
                                  <i class="b2font b2-arrow-right-s-line"></i>
                                </div>
                          ...
                          <router-link to="/userinfo/follow">
                            <div @click="sidebarActivate('follows')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['follows']}">
                                <a class="link-block"></a>
                                <p>
                                  <i class="b2font b2-hand-heart-line b2-light b2-color"></i>关注列表
                                </p>
                                <div class="author-sidebar-down">
                                  <i class="b2font b2-arrow-right-s-line"></i>
                                </div>
                          ...
                          <router-link to="/userinfo/vip">
                            <div @click="sidebarActivate('vipCenter')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['vipCenter']}">
                                <a class="link-block"></a>
                                <p>
                          ...
                          <router-link to="/userinfo/payInfo">
                            <div @click="sidebarActivate('orders')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['orders']}">
                                <a class="link-block"></a>
                                <p>
                          ...
                          <router-link to="/userinfo/charge">
                            <div @click="sidebarActivate('recharge')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['recharge']}">
                                <a class="link-block"></a>
                                <p>
                                  <i class="b2font b2-heart-add-line b2-light b2-color"></i>充值中心
                                </p>
                                <div class="author-sidebar-down">
                                  <i class="b2font b2-arrow-right-s-line"></i>
                                </div>
                          ...
                          <router-link to="/userinfo/changePw">
                            <div @click="sidebarActivate('passwordChange')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['passwordChange']}">
                                <a class="link-block"></a>
                                <p>
                                  <i class="b2font b2-hearts-line b2-light b2-color"></i>修改密码
                                </p>
                                <div class="author-sidebar-down">
                                  <i class="b2font b2-arrow-right-s-line"></i>
                                </div>
                          ...
                          <router-link to="/userinfo/chat/1">
                            <div @click="sidebarActivate('message')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['message']}">
                                <a class="link-block"></a>
                                <p>
                                  <i class="b2font b2-hearts-line b2-light b2-color"></i>私信
                                </p>
                                <div class="author-sidebar-down">
                                  <i class="b2font b2-arrow-right-s-line"></i>
                                </div>
                          ...
                          <router-link to="/userinfo/star">
                            <div @click="sidebarActivate('publish')"  class="user-sidebar">
                              <div :class="{'user-sidebar-info':true, 'active': this.sidebarItems['publish']}">
                                <a class="link-block"></a>
                                <p>
          ...
          <foot />
          <div infos="0">
            <div class="adBanner pub_300x250 pub_300x250m pub_728x90 text-ad textAd text_ad text_ads text-ads text-ad-links"></div>
          </div>
        </div>
      </div>
    </div>
...
import {  ChangeUser,getUserInfoById } from '@/api/user'
import {getUser} from '@/utils/userUtils'
import sidebarItem from "@/layout/components/Sidebar/SidebarItem.vue";
import {getResultRespCode, getResultRespData} from "@/utils/respUtils";
...
export default {
  ...
  data() {
    return {
      ...
      // 当前侧边栏项目的状态，初始时与initialSidebarItems相同
      sidebarItems: { ...this.initialSidebarItems },
      image: "",
  ...
  created() {
    ...
    if(user!==null){
      this.user = user ;
    }else if(this.$route.query.authorId!==undefined){
      this.user.userId = this.$route.query.authorId
      this.getUserInfo()
    }else{
      this.$router.push('/login')
      return
    }
    this.resetSidebarItems()
    this.sidebarItems["profile"] = true
  ...
  methods: {
    // 恢复侧边栏项目到初始值的方法
    resetSidebarItems() {
      // 通过展开操作符(...)来复制initialSidebarItems对象到sidebarItems
      this.sidebarItems = { ...this.initialSidebarItems };
    },
    sidebarActivate(newBar){
      this.resetSidebarItems()
      this.sidebarItems[newBar] = true
    },
    uploadFile: async function () {
      ...
      try {
        updateImage(formData).then(resp => {
          ...
          this.user.avatar = getResultRespData(resp).url;//根据返回值得不同这里要自己定义
          ChangeUser(this.user).then(resp => {
            if (getResultRespCode(resp) === 400) {
              ...
              localStorage.setItem('access-admin', JSON.stringify(this.user))
            }
          })
        }).catch((e) => {
    ...
    getUserInfo() {
      getUserInfoById(this.user.userId).then(resp=>{
        this.user = getResultRespData(resp);
      })
    },
    formatDate(time) {
